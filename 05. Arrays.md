...
* **List-based arrays** using Python's built-in list type (Can hold mixed data types).
* Array module arrays **using array from Python's array module** (**Homogeneous data** types only).
* **NumPy arrays** using the NumPy library for numerical computing (Optimized for **numerical computations**).
